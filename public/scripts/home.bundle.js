...
var User = function User(name, age, country) {
...
var form = document.querySelector('.main-section__content__item form');
var notification = document.querySelector('.main-section__content__notification');
var nameInput = form.elements[0],
    ageInput = form.elements[1],
    countryInput = form.elements[2];

var showNotification = function showNotification(res) {
...
form.addEventListener('submit', function (e) {
  ...
  var user = new _models_user__WEBPACK_IMPORTED_MODULE_1__["User"](name, age, country);
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/add-user', user).then(showNotification).catch(showNotification);
  nameInput.value = '';
  ageInput.value = '';
  countryInput.value = '';
});
